...
////            "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
//    private static final String INSERT_ROOMS_SQL = "INSERT INTO ROOM RECORD (roomNumber, capacity, roomStatus, buildingLocation, maintenanceNotes, roomType, hasProjector) " +
//            "VALUES (?, ?, ?, ?, ?, ?, ?)";
//
